...
try {
    $update_user   = $db->prepare('UPDATE user set 
                name = :name, email = :email, password_hash = :password_hash, cpf = :cpf, gender = :gender, 
                gender_identity = :gender_identity, contact = :contact, region = :region, is_escort = :is_escort, 
    ...
    $update_user->execute( array(
        ':name' => $_POST['name'], ':email' => $_POST['email'], ':password_hash' => $password, ':cpf' => $_POST['cpf'],
        ':gender' => $_POST['gender'], ':gender_identity' => $_POST['gender_identity'], ':contact' => $_POST['contact'],
        ':region' => $_POST['region'], ':is_escort' => $_POST['is_escort'], ':price' => $_POST['price'],
        ':id' => $_SESSION['user_id']) );
